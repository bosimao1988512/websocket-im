package com.taoge.websocketchat.netty;

import com.taoge.websocketchat.handler.TextWebSocketFrameHandler;
...
public class WebSocketServer {
    ...
    public static WebSocketServer inst = SingleInstance.instance;
    ...
    private class ChatServerInitializer extends ChannelInitializer<Channel> {
